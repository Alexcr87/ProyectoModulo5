...
export class InitialMigration1726594511511 implements MigrationInterface {
    name = 'InitialMigration1726594511511'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "dni" integer NOT NULL, "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "address" text NOT NULL, "city" character varying(50) NOT NULL, "country" character varying(50) NOT NULL, "rol" character varying NOT NULL DEFAULT 'usuario', "Suffrage" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
