            ...
            <div id="popup-modal"  className={isOpen ? 'fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ' : 'hidden'}>
                <div  className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="relative p-4 w-full max-w-md max-h-full">
                        <div className="relative bg-white bg-transparent rounded-lg shadow dark:bg-gray-700 w-[500px] h-[500px]">
                            ...
                            <div className="p-4 md:p-5 text-center ">
                                ...
                                <h3 className="mb-20 mt-12  text-xl font-normal text-gray-500 dark:text-gray-400">Seleccione la opción para registrar el usuario</h3>
                                <button 
